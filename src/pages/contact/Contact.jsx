					...
					<div className="contact__info">
						<div className="info__item">
							...
							<div>
								...
								<h4 className="info__desc">rabota.pashok@gmail.com</h4>
							</div>
						</div>
						<div className="info__item">
							...
							<div>
								...
								<h4 className="info__desc">+380934760198</h4>
							</div>
						</div>
					</div>

					<div className="contact__socials">
						<a href="https://github.com/PashKo911" className="contact__social-link">
							<FaFacebookF />
						</a>
						<a href="https://github.com/PashKo911" className="contact__social-link">
							<FaTwitter />
